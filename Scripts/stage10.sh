...
#SBATCH --error=%J.stage10.err
#SBATCH --output=%J.stage10.out
...
./asr.sh --stage 10 --stop_stage 10 --train_set train --valid_set dev --test_sets test --use_ngram true --asr_config "conf/train_asr_e_branchformer.yaml" --nbpe 128
conda deactivate
conda deactivate
##########################################################
echo "Ended at `date`"
