...
#SBATCH --error=%J.stage11.err
#SBATCH --output=%J.stage11.out
...
./asr.sh --stage 11 --stop_stage 11 --train_set train --valid_set dev --test_sets test --use_ngram true --asr_config "conf/train_asr_e_branchformer.yaml" --use_lm true --ngpu 8 --nbpe 128
conda deactivate
conda deactivate
##########################################################
echo "Ended at `date`"
